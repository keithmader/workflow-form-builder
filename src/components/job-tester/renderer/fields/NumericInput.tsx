...
export function NumericInput({ field, value, onChange, disabled, error }: NumericInputProps) {
  return (
    <div className="space-y-1">
      <input
        ...
        min={field.minimumValue?.value ?? undefined}
        max={field.maximumValue?.value ?? undefined}
